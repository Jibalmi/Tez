...
TEZ_DATA_DIR, TEZ_PORT, TEZ_HOST, TEZ_API_KEY, TEZ_LOG_LEVEL, TEZ_CORS_ORIGINS, TEZ_PRESETS, TEZ_LAYOUT,
TEZ_DEFAULT_TEMPERATURE and TEZ_EMBED_BACKEND, each also as VAR_FILE for Docker and Compose secrets (TEZ_API_KEY_FILE=/run/secrets/tez_api_key).
